 ...
 */
public class SideEnemies extends Enemy {

    SideEnemies(Image img, int x, int y, int speed, Random gen, Wingman wm) {
    ...
    public void update() {
        ...
        if (wm.b1 != null) {
            if (wm.b1.collision(x, y, sizeX, sizeY)) {
                ...
                wm.exp = new Explosion(wm.explosion1_1, wm.se.x, wm.se.y);
